...
<template>
    <div class="wrapper">
        ...
        <section class="r_list" ref="r_list">
            <div ref="b">
                <div
                    v-for="(it, index) in categoriesDetailData"
                    :key="index"
                    ref="good"
                >
        ...
        methods: {
            ...
            _initProductScroll() {
                if (!this.productScroll) {
                    ...
                    // 2.1 进入默认商品列表滚到顶部
                    this.productScroll.scrollToElement(
                        this.$refs.good[0],
                        10,
                        0,
                        0
            ...
            _isShowDropMenu() {
                ...
                this.isShowDropMenu =
                    ulContentWidth > subTitleWrapperWidth ? true : false;
            },
            // 商品详情页面
