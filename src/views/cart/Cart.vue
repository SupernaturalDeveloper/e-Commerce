...
<template>
    <div class="cart">
        ...
        <header class="titleWrapper">
            <h4>
                <strong>{{ $t("car.title") }}</strong>
            </h4>
            <div
                class="clearCart"
                :style="
                    selectedGoodsCount == 0 ? 'color:grey' : 'color:#45c763'
                "
                @click="clearCart"
                            ...
                            <div class="right">
                                ...
                                <div class="bottomContent">
                                    ...
                                    <div class="shopDeal">
                                        <span
                                            @click="
                                                reduceGoods(goods.id, goods.num)
                                            "
                                            >-</span
                                        >
                                        <input
                ...
                section {
                    ...
                    .shopCartListCon {
                        ...
                        .left {
                            ...
                            .cartCheckBox {
                                background: url("./../../images/cart/shop-icon.png")
                                    no-repeat;
