    ...
    <div id="order">
        ...
        <van-cell-group style="margin-top: 0.6rem">
            ...
            <van-cell>
                ...
                <span slot="title"
                    >{{ $t("order.use") }}{{ integral }}{{ $t("order.aliPay")
                    }}<b>{{ integralToprice | moneyFormat }}</b></span
                >
                <van-switch
                    v-model="checked"
                    slot="right-icon"
        ...
        <van-cell-group style="margin-top: 0.6rem">
            <van-cell :title="$t('order.totalMoney')">
                <div class="money">
                    {{ (selectedTotalPrice / 100) | moneyFormat }}
                </div>
            </van-cell>
        ...
        methods: {
            ...
            _initScroll() {
                if (!this.productImageScroll) {
                    ...
                    this.productImageScroll = new BScroll(
                        this.$refs.productImageWrapper,
                        {
                            probeType: 3,
                            startX: 0,
                            click: true,
