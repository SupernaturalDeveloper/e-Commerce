    ...
    <div id="myVip" ref="myVip">
        <div v-if="!isShowLoading">
            ...
            <div class="coupons">
                ...
                ><span class="desc">{{ $t("mine.cardRecoamnd") }}</span>
                <p class="todayCouns">
                    {{ $t("mine.TodayExclusivecoupon")
                ...
                <div class="quanBox">
                    ...
                    >
                        ...
                        <div class="couponsConditions">
                            {{ $t("mine.to") }}{{ item.pay_min
                            }}{{ $t("mine.toUse") }}
                        </div>
            ...
            <div class="coupons">
                ...
                ><span class="desc">{{ $t("mine.billTip") }}</span>
            ...
            <div class="coupons">
                ...
                ><span class="desc">{{ $t("mine.cardSpecial") }}</span>
                <!-- 可横向滑动的菜单 -->
